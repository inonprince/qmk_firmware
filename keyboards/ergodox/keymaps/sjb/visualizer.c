...
static const char* welcome_text = "Inon Prince";
static const char* revision_text = "720-336-0033";
static const char* keymap_text = "Keymap: " QMK_KEYMAP;
static const char* suspend_text = "ZZZZzzzz....";

static const uint8_t default_brightness_level = 0xFF;
static const uint32_t boot_lcd_color = LCD_COLOR(0x00, 0x00, 0x25); // initial color setting during boot sequence
static const uint32_t startup_animation_lcd_color = LCD_COLOR(0x00, 0x90, 0x90);
